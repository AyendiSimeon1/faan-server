...
parkingRouter.put('/session/:secureId/end', auth_1.protect, (0, auth_1.authorize)(common_1.UserRole.USER, common_1.UserRole.ADMIN), Parking_1.endSessionAndPay); // Add protect before authorize
parkingRouter.get('/sessions/history', auth_1.protect, (0, auth_1.authorize)(common_1.UserRole.ADMIN), Parking_1.getParkingHistory);
parkingRouter.post('/sessions/end', auth_1.protect, (0, auth_1.authorize)(common_1.UserRole.USER, common_1.UserRole.ADMIN), parkingSession_1.endParkingSession);
...
parkingRouter.post('/process-image', upload_1.upload.single('image'), ImageProcessing_1.processCarImage);
